    ...
    <VaCard class="w-full h-full flex-col flex">
        ...
        <div class="dialog-footer flex flex-row gap-2 mr-1">
            <div class="flex flex-row items-center gap-5">
                ...
                <VaButton v-if="meterStatus === true" color="primary" :loading="isOperating ? true : false"
                    @click="operateMeterStatus" class="h-[30px] w-[92px] text-nowrap">
                    Turn ON
                </VaButton>
                <VaButton v-if="meterStatus === false" color="primary" :loading="isOperating ? true : false"
                    @click="operateMeterStatus" class="h-[30px] w-[92px] text-nowrap">
                    Turn OFF
                </VaButton>
            </div>
