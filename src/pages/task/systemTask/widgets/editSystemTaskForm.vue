<template>
  ...
  >
    <div class="self-stretch grid grid-cols-[1fr_1fr] justify-start items-start gap-1">
      ...
      <div class="flex gap-4 flex-col w-full">
        <VaInput
          v-model="newControlTask.interval"
          label="Interval"
          class="w-full"
          type="number"
      ...
      <div class="flex gap-4 flex-col w-full">
        <VaInput
          v-model="newControlTask.startAt"
          label="Start Time"
          class="w-full"
          type="datetime-local"
          :rules="[validators.required]"
...
const tagOptions = ref<string[]>(['sys'])
